...
function menuRender(){
    return "<nav class='navbar navbar-expand-lg  shadowBody' style='background-color: #0B3C5D';color:white>"+
    ...
    "<div class='collapse navbar-collapse' id='navbarTogglerDemo01'>"+
      ...
      "<form class='form-inline my-2 my-lg-0'>"+
        ...
        "<button class='btn btn-outline-success my-2 my-sm-0' type='submit'><img src='sources/img/lupa.svg'></button>"+
      "</form>"+
    "</div>"+
  "</nav>"
}
